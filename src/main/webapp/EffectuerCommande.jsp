 ...
 <%
		...
		try {
			...
			FindIterable<Document> iterdoc = collection.find();
			 ...
			 %>
<div id="affichage">			 
<form class ="Form" action="AjouterCommande" method = "post">
 <table>
	<tr>
	...
	<tr>
		<td >
    						...
    						<td name="rate">
		    	   			...
		    	   			<td>
			                    <form  method="get" action="AjouterCommande">
		                             <label>Quantité</label>
			                            <input id="1" name="Qte" type="number" />
			                            <button id="commanderbutton"type="submit" >Commander</button>
			                    </form>
...
%>
    ...
    <td>
    <button  id="retouracceuil"type="submit" formaction="ListerCommandes.jsp">Consulter vos commandes</button>
    </td>
    </tr>
    </table>
    </form>
